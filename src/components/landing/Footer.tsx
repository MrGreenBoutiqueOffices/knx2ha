      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a
                  href="https://github.com/MrGreenBoutiqueOffices/knx2home/releases"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="transition-colors hover:text-primary"
                >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a
                  href="https://github.com/MrGreenBoutiqueOffices/knx2home/issues"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="transition-colors hover:text-primary"
                >
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-border/40 pt-8 text-sm text-muted-foreground sm:flex-row">
          <p className="text-sm text-muted-foreground">
            © {currentYear} KNX2HOME. Open source project.
          </p>
